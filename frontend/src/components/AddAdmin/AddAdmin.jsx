...
export default function AddAdmin(){
  ...
  const doAddAdmin = async() => {
    try {
      ...
      if(ethereum){
        ...
        const tx = await contract.assignAdmin(address.adminAddress)
  ...
  return (
    ...
    <div className="gpt3__header-content">
      <label>
       <div className="enter_csv gradient__text"> Add Admin </div>
       <br/>
    ...
    <button onClick={doAddAdmin} className="file_button remove_button">Add Admin</button>
</div>
  )
